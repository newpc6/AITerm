...
const emit = defineEmits<{
  ...
  export: [tool: Tool]
  selectionChange: [tools: Tool[]]
}>()

const tableRef = ref()

function handleSelectionChange(selection: Tool[]) {
...
<template>
  <div class="data-table">
    <el-table ref="tableRef" :data="tools" v-loading="loading" @selection-change="handleSelectionChange">
